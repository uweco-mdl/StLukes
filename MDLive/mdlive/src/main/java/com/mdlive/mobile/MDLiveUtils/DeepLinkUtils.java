package com.mdlive.mobile.MDLiveUtils;
...
//            BugSenseHandler.sendException(new Exception(SplashScreen.CRASH_PREPENDAGE + e.getMessage(), e));
    ...
    public static Intent getGeepLinkIntent(Context context){
        Intent intent = null;
        switch (DeepLinkUtils.PageCode.valueOf(DeepLinkUtils.DEEPLINK_DATA.getPage()).ordinal()){
            case 0:
                // Home screen
                intent = new Intent(context, MDLiveDashboardActivity.class);
                break;
            case 1:
                // Assist screen
                intent = new Intent(context, MDLiveDashboardActivity.class);
                intent.putExtra("showAssist", true);
                break;
            case 2:
                // SAV screen
                intent = new Intent(context, MDLiveGetStarted.class);
                break;
            case 3:
            ...
            case 5:
                ...
                intent = new Intent(context, MDLiveSymptomCheckerActivity.class);
                break;
            case 6:
                // My Account screen
